...
import { Search, Shield, Filter, Sparkles, ArrowRight, BookOpen, Compass } from 'lucide-react'
    ...
    <div className="min-h-screen bg-ivory-50 flex flex-col font-sans">
      ...
      <section className="relative h-80 sm:h-96 flex items-center justify-center overflow-hidden bg-forest-950">
        <div className="absolute inset-0 opacity-40">
          <OptimizedImage
            src="https://images.unsplash.com/photo-1526095179574-86e545346ae6?auto=format&fit=crop&w=1920&q=85"
        ...
        <div className="relative z-10 text-center text-ivory-50 px-4 max-w-4xl mx-auto">
          ...
          <p className="mt-4 text-base md:text-lg text-ivory-200 max-w-2xl mx-auto leading-relaxed">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        ...
        <div className="bg-white rounded-2xl border border-sand-200 p-5 shadow-sm mb-10 space-y-4">
          <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between">
            ...
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search species by common or scientific name (e.g. Grevy's Zebra, Oryx)..."
                value={search}
                onChange={e => setSearch(e.target.value)}
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-sand-200 bg-ivory-50/50 text-sm focus:outline-none focus:ring-2 focus:ring-forest-700 focus:bg-white transition-all text-charcoal-900 placeholder:text-charcoal-700"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="text-xs font-medium bg-ivory-50 border border-sand-200 rounded-lg px-3 py-2 text-charcoal-900 focus:outline-none focus:ring-2 focus:ring-forest-700"
              >
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-2xl border border-sand-200 p-8">
            ...
            <h3 className="text-xl font-display font-semibold text-charcoal-900 mb-1">No wildlife records found</h3>
            ...
            {filtered.map(spec => (
              ...
              >
                <div>
                  ...
                  <div className="p-6">
                    <h3 className="font-display text-xl font-bold text-charcoal-900 group-hover:text-forest-900 transition-colors">
                      {spec.title}
                    </h3>
                    <p className="text-xs text-charcoal-700 italic mt-0.5 font-serif">
                      {spec.scientificName}
                    </p>
                    <p className="text-sm text-charcoal-700 mt-3 line-clamp-2 leading-relaxed">
                      {spec.excerpt}
                    </p>
                  </div>
                </div>

                <div className="px-6 pb-6 pt-2 border-t border-sand-100 flex items-center justify-between text-xs font-semibold text-forest-800 group-hover:text-forest-950">
